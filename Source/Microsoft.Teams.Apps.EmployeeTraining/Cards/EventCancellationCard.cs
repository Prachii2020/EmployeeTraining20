...
namespace Microsoft.Teams.Apps.EmployeeTraining.Cards
{
    ...
    public static class EventCancellationCard
    {
        ...
        public static Attachment GetCancellationCard(string applicationBasePath, IStringLocalizer<Strings> localizer, EventEntity eventEntity, string applicationManifestId)
        {
