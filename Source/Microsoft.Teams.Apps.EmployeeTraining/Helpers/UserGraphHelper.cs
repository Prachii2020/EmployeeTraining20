...
namespace Microsoft.Teams.Apps.EmployeeTraining.Helpers
{
    ...
    public class UserGraphHelper : IUserGraphHelper
    {
        ...
        /// </summary>
        private const int MaxResultCountForRecentCollaborators = 50;
        ...
        /// <summary>
        /// Get top N recent collaborators for a user.
        /// </summary>
        /// <returns>List of users.</returns>
        public async Task<IEnumerable<Person>> GetRecentCollaboratorsAsync()
        {
