            ...
            let rows = this.state.selectedUsersAndGroups.map((member, index) => {
                return {
                    ...
                    "items": [
                        ...
                        {
                            content: <TrashCanIcon onClick={() => this.deleteItem(index)} />,
        ...
        return (
            <React.Fragment>
                ...
                <Flex gap="gap.smaller" className="button-footer" vAlign="center">
                    ...
                    <Button content={this.localize("nextButton")} disabled={this.state.isLoading} primary onClick={this.nextBtnClick} data-testid="next_button" />
                </Flex>
            </React.Fragment>
        );
    }
