...
class CreateEventStep3 extends React.Component<ICreateEventsStep3Props, ICreateEventsStep3State> {
    ...
    */
    ...
    getEventAudience = () => {
        if (this.props.eventPageState.eventDetails.audience === EventAudience.Private) {
            return <Label className="category-type-label" circular icon={<EyeSlashIcon />} iconPosition="start" content={this.props.eventPageState.selectedAudience?.header!} />;
        }
        else {
            return <Label className="category-type-label" circular icon={<EyeIcon />} iconPosition="start" content={this.props.eventPageState.selectedAudience?.header!} />;
        }
    }
        ...
        return (
            <>
                <div className="page-content create-event-step3">
                    ...
                    <Image className="event-image" fluid src={this.props.eventPageState.eventDetails.photo} />
                ...
                <Flex gap="gap.smaller" className="button-footer" vAlign="center">
                    ...
                    </Flex.Item>
                    {
                        (this.props.eventPageState.isDraft || !this.props.eventPageState.isEdit) && <>
                            ...
                            <Button disabled={this.state.isCreateLoading || this.state.isDraftLoading} loading={this.state.isCreateLoading} content={this.localize("createEventButton")} primary onClick={this.createEvent} data-testid="create_event_button" />
                        </>
                    }
                    {
                        !this.props.eventPageState.isDraft && this.props.eventPageState.isEdit && <>
